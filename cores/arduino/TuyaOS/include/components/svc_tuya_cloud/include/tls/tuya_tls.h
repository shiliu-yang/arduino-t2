...
/**
 * @brief ap netcfg tls recieve
 *
 * @param[in] tls_handler tls_handler refer to tuya_tls_hander
 * @param[out] buf buf
 * @param[out] len len
 *
 */
...
/**
 * @brief ap netcfg tls connect
 *
 * @param[out] tls_handler tls_handler refer to tuya_tls_hander
 * @param[in] socket_fd tls client socket_fd
 * @param[in] overtime_s overtime
 *
 */
OPERATE_RET tuya_tls_connect_ap(OUT tuya_tls_hander *p_tls_handler, IN INT_T socket_fd, IN INT_T overtime_s);

/**
 * @brief ap netcfg tls disconnect
 *
 * @param[in] tls_handler tls_handler refer to tuya_tls_hander
 *
 */
