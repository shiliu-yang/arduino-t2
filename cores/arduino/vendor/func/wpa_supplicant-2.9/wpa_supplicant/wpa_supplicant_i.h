...
struct wpa_supplicant {
	...
	int reassociate:1; /* reassociation requested */
	...
	int disconnected:1; /* all connections disabled; i.e., do no reassociate
			   * before this has been cleared */
	int ap_ies_from_associnfo:1;
