...
#define BSSID_INFO_ADDR            0x1D1000 /*reserve 4k for bssid info*/

#if (FAST_CONNECT_INFO_ENC_METHOD == ENC_METHOD_XOR)
void wlan_fci_enc(struct wlan_fast_connect_info *bssid_info)
{
...
void wlan_fci_dec(struct wlan_fast_connect_info *bssid_info)
{
	struct wlan_fast_connect_info tmp_out;
	GLOBAL_INT_DECLARATION();
