...
typedef union
{
    struct
    {
        ...
        volatile unsigned int Reserved       : 2;  /**< NC */
        volatile unsigned int TRIANGLE_AMP   : 1; /**< ���ǲ����ȷ�Χ��0�� 2048~2560 1�� 2048~3072 */
        volatile unsigned int DPD_ADDR_SCALE : 1;  /**< PD ��ַ���ţ�0��1/2 1: 1/4 */
...
typedef union
{
    struct
    {
        volatile unsigned int QCONSTANT   : 12; /**< �����䳣��ʱ��Q��ֵ */
        volatile unsigned int Reserved    : 3;  /**< NC */
        volatile unsigned int DPD_EN      : 1;  /**< DPD enable */
        volatile unsigned int ICONSTANT   : 12; /**< �����䳣��ʱ��I��ֵ */
        volatile unsigned int TXPOWTBLEN  : 1;  /**< Tx Power Table Enable;  0x0: ��������Table��д;  0x1: Ӳ������Table�� */
        volatile unsigned int TXCOMPDIS   : 1;  /**< ���Ͳ������ܽ�ֹ��;0x0: ʹ�ܷ��Ͳ���;0x1: ��ֹ���Ͳ��� */
        volatile unsigned int TESTPATTERN : 2;  /**< 0������ģʽ��������������Modem������; 1��I/Q���䳣��; 2��I/Q�������������Ҳ�; 3��I/Q�������ǲ� */
    } bits;
    volatile unsigned int value;
...
typedef union
{
    struct
    {
        ...
        volatile unsigned int Reserved_        : 5;  /**< IQ�ź��������;0��1.75 dB��;��. 31��-6dB;; */
